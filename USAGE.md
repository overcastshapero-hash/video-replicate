...
> ⚠️ **看清楚边界再装**:本 skill 只做**视觉驱动型**视频复刻
> (AI 短片、MV、广告、纯运镜、视觉创意片)。
>
> **不做**:口播 / 解说 / 知识科普 / 做菜 / reaction / vlog / 手绘解说类。
> 这些视频灵魂在讲稿不在画面,本 skill 不做 ASR / TTS / 讲稿改写 / 新字幕——
> 强行做出来会是"画面酷炫但什么都没说"。
>
> 想做口播类?请先用 `video-transcript` 拿讲稿,人工改写后用 HeyGen / D-ID 之类的口播生成工具。
...
### 类型上不做(用错地方,别失望)
- ❌ **口播 / 解说 / 知识科普 / 做菜 / reaction / vlog / 手绘解说类** — 灵魂在讲稿不在画面,本 skill 不做 ASR/TTS/讲稿改写,产出空洞
- ❌ **TED 演讲 / 访谈类** — 同上
...
- 内容创作者: 看到别人爆款的**视觉风格**想做同款(不管用什么生成工具)
- AI 视频玩家: 做"机器人雅戈"那种视觉系 AI 短片,批量复刻不同风格做对照
- 广告/MV 制作: 借鉴成熟运镜和调色,换主体改编
- 想把「视频结构复刻方法论」沉淀成自己可复用的内部工具的人

**不适合**:
- ❌ 口播博主(做菜、科普、reaction、vlog) — 灵魂在讲稿,本 skill 不管
- ❌ 想 100% 照搬别人作品的人 — skill 会拒绝
